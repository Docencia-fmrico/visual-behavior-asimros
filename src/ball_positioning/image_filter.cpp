...
void ImageConverter::initChannel(HSVInfo * hsvinfo, int i)
{
  hsvinfo->hsv[IDX_h] = 0;
...
void ImageConverter::imageCb(const sensor_msgs::Image::ConstPtr& msg)
{
...
void ImageConverter::publishHSV()
{
  for (int i=0; i < MAX_CHANNELS; i++)
  {
